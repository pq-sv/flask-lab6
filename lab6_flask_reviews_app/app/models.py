...
from sqlalchemy import String, ForeignKey, Text, Integer, MetaData, DateTime, UniqueConstraint
...
class Course(Base):
    ...
    rating_num: Mapped[int] = mapped_column(default=0, nullable=False)
...
class Review(Base):
    ...
    def __repr__(self):
        return '<Review course=%r user=%r rating=%r>' % (self.course_id, self.user_id, self.rating)
